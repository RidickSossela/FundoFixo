...
class Fundofixo extends Model
{
    ...
    public static function buscaNr($id){
        ...
        ->select('fundofixos.id','fundofixos.nr','fundofixos.ano','fundofixos.periodoIni',
                'fundofixos.periodoFim','fundofixos.valorTotal',
                'unidades.fazenda', 'unidades.funcionario')
        ->get();
